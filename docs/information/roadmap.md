...
* Details
  * Phase 1: ~~<mark style={{backgroundColor: 'red'}}>Dec 1 - Dec 15</mark>~~ -> <mark style={{backgroundColor: 'green'}}>Dec 1 - Dec 31</mark>
  * Phase 2: ~~<mark style={{backgroundColor: 'red'}}>Dec 16 - Jan 15</mark>~~ -> <mark style={{backgroundColor: 'green'}}>Jan 1 - Feb 2</mark>
  * Phase 3: ~~<mark style={{backgroundColor: 'red'}}>Jan 16 - Jan 25</mark>~~ -> <mark style={{backgroundColor: 'green'}}>Feb 3 - Fe</mark><mark style={{backgroundColor: 'green'}}>**b 23**</mark>
  * Phase 4: ~~<mark style={{backgroundColor: 'red'}}>Feb 3 - Feb 22</mark>~~ -> <mark style={{backgroundColor: 'green'}}>Feb 24 - Ap</mark><mark style={{backgroundColor: 'green'}}>**r 6**</mark>
  * Phase 5: ~~<mark style={{backgroundColor: 'red'}}>Feb 23 - Mar 15</mark>~~ -> <mark style={{backgroundColor: 'green'}}>Apr 7 - May 31</mark>
  * Phase &#x36;**:** ~~<mark style={{backgroundColor: 'red'}}>Mar 16 - further</mark>~~ -> <mark style={{backgroundColor: 'green'}}>Jun 1 - Ongoing</mark>
